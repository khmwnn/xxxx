...
def calculate_distance(psi, angle_in_degrees):
    ...
    logging.debug('现在运行calculate_distance函数')
...
def get_user_input(name):
    ...
    logging.debug('现在运行get_user_input函数')
    try:
...
def get_player_names():
    ...
    logging.debug('现在运行get_player_names函数')
...
def process_player_turn(player_name, distance_apart):
    ...
    logging.debug('现在运行process_player_turn函数')
